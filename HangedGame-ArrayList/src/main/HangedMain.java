	...
	public static void main(String[] args) {
		...
		do{
			...
			switch(select){
				...
				case "jugar":
				case "JUGAR":
					Dictionary.SecretWord secretWord = dictionary.getNextWord();
					board.startGame(secretWord.getWord(),difficult);
					System.out.println("PISTA : " + secretWord.getHint());
					...
					do{
						UserInterface.showMenuBoard(wordPlayer, secretWord.getHint(), board.getMaxFails()-board.getCurrentfails());
